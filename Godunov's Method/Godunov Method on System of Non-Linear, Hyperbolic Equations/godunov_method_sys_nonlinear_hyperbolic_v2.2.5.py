"""
    ...
    Version 2:
        ...
        Test 5: Consists of a left rarefaction wave, a right-travelling shock wave and a 
                stationary contact discontinuity. This test is used to asses the ability of
                the numerical methods to resolve slowly-moving contact discontinuities
"""
...
def godunov_method_sys_nonlinear_hyperbolic():
    ...
    while ( t <= time_period ):
        ...
        if ( count % plot_it == 0 ):
            ...
            plt.tight_layout()
            plt.savefig('test-4_itn-' + str(count) + '.png')
            #plt.show()
